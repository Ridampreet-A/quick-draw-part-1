...
// Define an array containing quick draw sketches
quick_draw_data_set = [
  ...
  // Print the random sketch name to the console
  console.log(quick_draw_data_set[random_number]);
  
  // Store the random sketch name in the sketch variable
  Element_of_array = array_1[random_number];
  
  // Update the text of the span tag with the sketch variable
